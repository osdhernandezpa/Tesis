...
(set! geometry (list (make block
                       (center 0.32 0 0) (size 0.64 infinity infinity)
                       (material (make dielectric (epsilon 4.7)) ) )
                     (make block
                       (center 0.72 0 0) (size 0.16 infinity infinity) 
                       (material (make dielectric (epsilon 2.35)) ) ) ))
                     (make block
                       (center 0.9 0 0) (size 0.2 infinity infinity) 
